...
const BottomNav = ({ activeItem }: BottomNavProps) => {
  ...
  const { isDrag, setDrag } = useMyContext();
        ...
        >
          <div className="mx-auto  grid h-16 max-w-lg grid-cols-5">
            ...
            <NavButton
              ...
              label="Services"
              isActive={
                activeItem === "services" || location.pathname == "/services"
              }
            />
            ...
            <NavButton
              ...
              label="Events"
              isActive={
                activeItem === "events" || location.pathname == "/events"
              }
            />
            ...
            <NavButton
              ...
              label="SR"
              isActive={
                activeItem === "sim-racing" ||
                location.pathname == "/sim-racing"
              }
            />
          </div>
          <input
