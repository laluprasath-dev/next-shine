          ...
          <div className="flex gap-2">
            <button className="p-1 hover:bg-gray-100 rounded">
              <Eye
                ...
                onClick={() =>
                  window.open(
                    "https://storage.googleapis.com/amazing-insight-415210.appspot.com/Documents/file/as122ds_332_asa222.pdf"
                  )
                }
              />
            </button>
...
const EnhancedVendorProfile: React.FC<EnhancedVendorProfileProps> = ({
  vendorRegistration,
}) => {
  const [currentLogoUrl, setCurrentLogoUrl] = useState<string | null>(
    vendorRegistration.business_logo_url
  );
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6 md:space-y-10">
          ...
          <div className="flex items-start justify-between">
              ...
              <div className="flex-1 min-w-0 space-y-3">
                <div>
                  ...
                  <p className="text-lg text-gray-600 font-medium mt-1">
                    {vendorRegistration.personal_name}
                  </p>
                </div>
            ...
            <div className="text-right space-y-1">
              ...
              <div className="text-lg font-bold text-gray-900">
                {new Date(vendorRegistration.created_at).toLocaleDateString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "long",
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {vendorRegistration.categories?.length || 0}
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {vendorRegistration.branches?.length || 0}
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div>
              ...
              <p className="text-gray-900 font-medium mt-1">
                {vendorRegistration.account_holder_name}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-900 font-mono mt-1">
                ****{vendorRegistration.bank_account_number.slice(-4)}
              </p>
            </div>
        ...
        <CardContent className="max-[769px]:px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
            <div>
              ...
              <p className="text-gray-900 font-medium mt-1">
                {vendorRegistration.government_id_type}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-900 font-mono mt-1">
                ****{vendorRegistration.government_id_number.slice(-4)}
              </p>
            </div>
          </div>
        </CardContent>
      ...
      {/* Branch Locations */}
      {vendorRegistration.branches &&
        Array.isArray(vendorRegistration.branches) &&
        vendorRegistration.branches.length > 0 && (
          <Card>
            <CardHeader className="max-[769px]:px-4">
              <CardTitle className="flex items-center max-[769px]:text-[22px]">
            ...
            <CardContent className="max-[769px]:px-4">
              <div className="space-y-3 md:space-y-6">
                {vendorRegistration.branches.map(
