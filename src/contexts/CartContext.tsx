        ...
        const cartItemsWithDetails = await Promise.all(
          (data as DbCartItem[]).map(async (item) => {
            if (productsIds.includes(item.product_id)) {
              ...
              if (cachedProduct) {
                return {
                  ...
                  length: cachedProduct.length,
                  breadth: cachedProduct.breadth,
                  height: cachedProduct.height,
                  pickup_postcode: cachedProduct.pickup_postcode,
                };
              }
              ...
              return {
                ...
                weight: (product as SimProductLite | null)?.weight,
                length: (product as SimProductLite | null)?.length,
                breadth: (product as SimProductLite | null)?.breadth,
                height: (product as SimProductLite | null)?.height,
                pickup_postcode: (product as SimProductLite | null)
                  ?.pickup_postcode,
              };
            }
            ...
            return {
              ...
              weight: (product as ShopProductLite | null)?.weight,
              length: (product as ShopProductLite | null)?.length,
              breadth: (product as ShopProductLite | null)?.breadth,
              height: (product as ShopProductLite | null)?.height,
              pickup_postcode: (product as ShopProductLite | null)
                ?.pickup_postcode,
            };
          })
        );
        ...
        if (existingItem) {
          ...
          if (data) {
            ...
            const newItem: CartItem = {
              ...
              pickup_postcode: product.pickup_postcode,
            };
