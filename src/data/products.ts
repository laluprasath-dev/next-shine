...
export const categoryData = {
  "oem-parts": {
    ...
    subCategories: {
      ...
      "Electricals & Sensors": [
        ...
        "Switches",
        "Horns",
        "ABS/O2/Knock/Crank/Temperature Sensors",
      ],
      "Lights (OEM Style)": [
        "Headlamps",
        "Tail Lamps",
    ...
    filters: [
      ...
      {
        name: "Fast-Moving Tags",
        options: ["Essentials", "Top Seller", "Frequently Bought"],
      },
  ...
  "motorsports-competition": {
    ...
    subCategories: {
      "Safety & Equipment": [
        "Roll Cages (Bolt-in / Weld-in)",
        "Racing Seats (FIA-Approved)",
        "Seat Mounts & Harnesses",
        "Helmets (FIA Spec, Rally, Track)",
        "Racing Suits (Fireproof, Lightweight)",
        "Gloves",
        "Shoes",
        "Balaclavas",
        "HANS Devices & Neck Supports",
        "Fire Extinguishers / Cutoff Switches",
        "Fuel Cells",
        "Quick Fills",
        "Dry Breaks",
        "Rally Trip Computers",
        "Pit Stop Equipment & Organizers",
  ...
  "brakes-suspension": {
    ...
    filters: [
      ...
      {
        name: "Suspension Style",
        options: ["Air", "Hydraulic", "Coilover", "OEM"],
      },
  ...
  "car-care-detailing": {
    ...
    subCategories: {
      ...
      "Dry Ice / Nitrogen Deep Cleaning": [
        "Advanced professional cleaning kits",
      ],
  ...
  "toys-models-collectibles": {
    ...
    subCategories: {
      "Ride-on Electric Cars & Bikes (Kids)": [
        "Battery-Powered Mini Jeeps",
        "BMWs",
        "Supercars",
      ],
      ...
      "Diecast & Miniatures": [
        "1:18",
        "1:24",
        "1:64 scale (AutoArt, Hot Wheels, etc.)",
      ],
  ...
  "books-magazines-docs": {
    ...
    subCategories: {
      "Auto Magazines (Print + Digital)": [
        "Monthly",
        "Special Editions (AutoCar, Evo India)",
      ],
      "Owner Manuals & Service Books": [
        "OEM Handbook Reprints & PDF Downloads",
      ],
      "Tuning Handbooks & Build Diaries": [
        "Suspension",
        "ECU",
        "Aero Mods",
        "Dyno Logs",
  ...
  "vendors-storefronts": {
    ...
    subCategories: {
      ...
      "Garage Storefronts": [
        "Verified Workshops",
        "Local Mechanics with Shops",
      ],
      "Retailers & Resellers": [
        "Pan-India Retail Chains",
        "Online Distributors",
      ],
      "Creator & Influencer Shops": [
        "Limited Merch",
        "Stickers",
        "Builds-for-Sale",
      ],
  ...
  "offroad-adventure": {
    ...
    filters: [
      {
        name: "Terrain Type",
        options: ["Gravel", "Sand", "Rock Crawling", "Rally", "Mud Terrain"],
      },
