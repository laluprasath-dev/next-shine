...
export const simAppApi = {
  ...
  return supabase
    ...
    registerForLeague: (leagueId: string, userId: string, registrationData: any) => 
    ...
    registerTeamForLeague: (leagueId: string, teamId: string, driverIds: string[], registrationData: any) =>
 ...
 getTeamLeagueStandings: (leagueId: string) =>
  ...
  events: {
    ...
    getEventDetails: (id: string) => 
     ...
     ,
    registerForEvent: (eventId: string, userId: string, registrationData: any) => 
  ...
  products: {
    ...
    placeOrder: (userId: string, products: Array<{id: string, quantity: number, price: number}>, shippingAddress: any) => {
  ...
  garages: {
    ...
    bookService: (userId: string, serviceId: string, bookingData: any) => 
      supabase
