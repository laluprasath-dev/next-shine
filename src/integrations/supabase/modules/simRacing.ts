...
export const simRacingApi = {
  ...
  events: {
    ...
    registerSolo: (eventId: string, userId: string, registrationData: any) => 
    ...
    registerTeam: (eventId: string, teamId: string, driverIds: string[], registrationData: any) => {
  ...
  shop: {
    ...
    createProduct: (productData: Omit<Partial<SimProduct>, 'id' | 'created_at' | 'updated_at'>) => 
      supabase.from('sim_products').insert(productData),
