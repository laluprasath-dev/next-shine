      ...
      <div className="bg-white min-h-screen">
        ...
        <section className="container max-[769px]:px-3 py-6 md:py-12">
         ...
         <div className="flex py-1 md:py-0 justify-between items-center mb-1">
            ...
            <Link to={"/shop/category/performance-racing-parts"} className="text-sm-red flex items-center hover:underline">
        ...
        <section className="py-6 bg-gray-50">
          ...
          <div className="flex py-1 md:py-0  justify-between items-center mb-1">
            ...
            <Link to={"/vehicles/category/performance-racing"} className="text-sm-red flex items-center hover:underline">
