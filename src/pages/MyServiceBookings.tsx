    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          service:services(*),
          vendor:vendor_id(username, full_name, avatar_url)
        `)
        .eq("user_id", user.id);
                  ...
                  <CardHeader className="pb-2">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-sm font-semibold text-sm-red">
                       {booking.service.price?.startsWith('₹') ? booking.service.price : `₹${booking.service.price}`}
                      </div>
                    </div>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center pt-2">
                        <Avatar className="h-8 w-8 mr-2 ring-2 ring-sm-red/10">
                          <AvatarImage src={booking.vendor?.avatar_url} />
                          <AvatarFallback>
