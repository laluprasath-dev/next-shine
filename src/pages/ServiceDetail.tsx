...
console.log(serviceData)
  ...
  const filteredTimes = filterAvailableTimes(service?.availability|| {},selectedDate);
    ...
    <Layout>
      <div className="container px-4 py-4 mx-auto">
        ...
        <div className="text-sm text-gray-500 mb-4">
          ...
          {category && (
            <>
              <button onClick={() => navigate(`/services?category=${service.category}`)} className="hover:underline">{category.name}</button>
              {" > "}
            </>
          )}
              ...
              <CardContent>
                ...
                <div className="flex justify-center space-x-2">
                  <Button 
                    variant="outline" 
                    size="sm" 
                    onClick={() => navigate(`/profile/${service.profile?.id}`)}
                  >
...
function filterAvailableTimes(availability, selectedDate) {
