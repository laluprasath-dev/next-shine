...
const VehicleCategory = () => {
 ...
 useEffect(()=>{
  ...
  const categoryData = category ? categoryInfo[category] || { name: category, description: "", image: "" } : null;
                ...
                <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                      ...
                      <Select value={filters.maxPrice} onValueChange={(value) => handleFilterChange("maxPrice", value=="all"?undefined:value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select value={filters.minYear} onValueChange={(value) => handleFilterChange("minYear", value=="all"?undefined:value)}>
                        <SelectTrigger>
