  ...
  return (
    <AdminLayout title="Sim Racing Events Management">
      <div className="flex flex-col md:flex-row justify-between gap-y-4 border md:border-0 py-4 border-gray-300 rounded-md px-4 md:px-1 w-full md:items-center mb-6">
        ...
        <Link to="/admin/sim-events/create">
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => navigate(`/admin/sim-events/edit/${event.id}`)}>
                            <Edit className="mr-2 h-4 w-4" /> Edit
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => navigate(`/admin/sim-events/participants/${event.id}`)}>
                            <Users className="mr-2 h-4 w-4" /> Participants
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => navigate(`/admin/sim-events/results/${event.id}`)}>
