      ...
      <Layout>
        <div className="container mx-auto py-8">
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <Button onClick={() => navigate('/sim-racing/events')}>Back to Events</Button>
          </div>
        </div>
      </Layout>
    );
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <Button
          variant="ghost"
          onClick={() => navigate('/sim-racing/events')}
          className="mb-6 px-0"
        >
            ...
            <div>
              ...
              <Tabs defaultValue="details">
                            ...
                            <div className="flex justify-between">
                              ...
                              <dd className="text-sm font-medium">
                                <Button
                                  ...
                                  onClick={() => navigate(`/sim-racing/leagues/${eventData.league_id}`)}
                                >
                ...
                <TabsContent value="participants">
                  ...
                  {
                    !(leagueStandings?.teams.length || leagueStandings?.solo.length) && (
                ...
                {showRegistrationForm ? (
                  ...
                  <div className="text-center py-4">
                    ...
                    <Button
                      variant="outline"
                      className="w-full"
                      onClick={() => navigate('/sim-racing/my-events')}
                    >
                      View My Events
                    </Button>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <Button
                        ...
                        onClick={() => navigate(`/profile/${eventData.creator.id}`)}
                      >
                        View Profile
                      </Button>
                    </div>
