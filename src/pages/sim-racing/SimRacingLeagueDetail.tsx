      ...
      <Layout>
        <div className="container mx-auto py-8">
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <Button onClick={() => navigate("/sim-racing/leagues")}>
              Back to Leagues
            </Button>
          </div>
        </div>
  ...
  return (
    <Layout>
      <div className="container mx-auto py-4">
        <Button
          variant="ghost"
          onClick={() => navigate("/sim-racing/leagues")}
          className="mb-6 px-0"
        >
                        ...
                        <Card key={event.id} className="overflow-hidden">
                          ...
                          <CardContent className="p-4">
                            ...
                            <Button
                              ...
                              className="w-full"
                              onClick={() =>
                                navigate(`/sim-racing/events/${event.id}`)
                              }
                            >
                              View Event
                            </Button>
                ...
                <TabsContent value="standings" className="pt-4">
                  {isLoadingStandings ? (
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-md overflow-y-scroll scrollbar-hide shadow">
                              <table className="min-w-full divide-y overflow-y-auto divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 ">
                                  {leagueStandings.solo.map((entry, index) => (
                                    <tr
                                      key={entry.id}
                                      className={
                          ...
                          <div>
                            ...
                            <div className="bg-white rounded-md overflow-scroll scrollbar-hide shadow">
                              <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                  {leagueStandings.teams.map((entry, index) => (
                                    <tr
                                      key={entry.id}
                                      className={
                                        index === 0 ? "bg-blue-50" : ""
                      ...
                      {!(
                        leagueStandings?.teams.length ||
                        leagueStandings?.solo.length
                      ) && (
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm">
                            {leagueData.registration_type === "solo_only"
                              ? "This league is for solo drivers only."
                              : leagueData.registration_type === "team_only"
                ...
                {showRegistrationForm ? (
                  ...
                  <div className="text-center py-4">
                    ...
                    <Button
                      variant="outline"
                      className="w-full"
                      onClick={() => navigate("/sim-racing/my-leagues")}
                    >
                      View My Leagues
                    </Button>
                  </div>
                  ...
                  <div>
                    <p className="text-sm text-gray-500 mb-4">
                      {new Date(leagueData.start_date) > new Date()
                    ...
                    <Button
                      ...
                      disabled={new Date(leagueData.start_date) <= new Date()}
                    >
                      Register Now
                    </Button>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(`/profile/${leagueData.organizer.id}`)
                        }
                      >
                        View Profile
                      </Button>
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-3 mt-3">
                  <TimelineItem
                    ...
                    label="League Start"
                    isPast={new Date(leagueData.start_date) < new Date()}
                  />
