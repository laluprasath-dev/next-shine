...
const ServiceManagement = () => {
  ...
  const handleRequestMoreTime = async (bookingId, additionalTime) => {
    try {
  ...
  const getDateBookingStatus = (date) => {
    if (!date) return null;
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex gap-1">
                            <Link to={`/vendor/service/edit/${service.id}`}>
                              <Button variant="outline" size="sm">
