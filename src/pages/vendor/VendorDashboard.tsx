...
const VendorDashboard = () => {
  ...
  const { data: updateRequestsData, isLoading: requestsLoading } = useQuery({
    ...
    queryFn: () => vendorApi.getUpdateRequests(vendorData!.data.id),
    enabled: !!vendorData?.data?.id,
  });

  const vendorRegistration =
    vendorData?.data as any as VendorRegistration | null;
        ...
        <div className=" mx-auto space-y-4 md:space-y-6">
          <div className="flex items-baseline md:items-center justify-between gap-y-4  flex-col md:flex-row">
            <div className="flex flex-col items-baseline">
              ...
              <p className="text-gray-600 mt-2">
                Manage your vendor registration and business
              </p>
            </div>
              ...
              {vendorRegistration.is_verified_by_admin && (
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <p className="text-green-700">
                    Your vendor registration has been approved. You can now
