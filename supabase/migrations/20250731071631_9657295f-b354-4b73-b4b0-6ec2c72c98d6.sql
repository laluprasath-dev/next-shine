-- Check if user_purchases table exists and drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view their own purchases" ON public.user_purchases;
DROP POLICY IF EXISTS "System can insert purchases" ON public.user_purchases;
