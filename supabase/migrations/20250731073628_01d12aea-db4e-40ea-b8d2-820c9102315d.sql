-- Update the trigger function to use the correct Supabase method for calling edge functions
...
BEGIN
  ...
  -- Call the send-notification edge function using Supabase's method
